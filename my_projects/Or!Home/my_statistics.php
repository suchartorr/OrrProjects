...
class my extends my_page {
	function __construct()
	{
		 ...
		 */
		 $my_form->set_controls(new OrTextbox('name'));
                 $my_form->set_controls(new OrTextbox('month_01'));
                 $my_form->set_controls(new OrTextbox('month_02'));
                 $my_form->set_controls(new OrTextbox('month_03'));
                 $my_form->set_controls(new OrTextbox('month_04'));
                 $my_form->set_controls(new OrTextbox('month_05'));
                 $my_form->set_controls(new OrTextbox('month_06'));
                 $my_form->set_controls(new OrTextbox('month_07'));
                 $my_form->set_controls(new OrTextbox('month_08'));
                 $my_form->set_controls(new OrTextbox('month_09'));
                 $my_form->set_controls(new OrTextbox('month_10'));
                 $my_form->set_controls(new OrTextbox('month_11'));
                 $my_form->set_controls(new OrTextbox('month_12'));
